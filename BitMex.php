...
class BitMex {
  ...
  public function editOrderPrice($orderID,$price = NULL,$stop = NULL) {
  ...
  public function createOrder($type,$side,$price,$quantity,$execInst = NULL,$maker = false) {
  ...
  /*
   *
   * Create Multiple Orders with POST/order/bulk
   * 
   * Pass in orders as arrays
   * 
   * @return array with orders
   *
   */

  public function createOrders($type,$side,$price,$quantity,$stop = NULL, $execInst = NULL) {
   ...
   * 
   * @return stop loss order array
   * 
   * default is Stop Limit order
   * 
   */

  public function createStopLimit($side,$price,$quantity,$stop) {
   ...
   * @return stop loss order array
   * 
   * default is Stop Market order
   * 
   */

  public function createStop($side,$quantity,$stop) {
   ...
   * Cancel Order
   *
   * Cancel order passing
   * the orderID as argument
   *
   * @return closed order array
   */
